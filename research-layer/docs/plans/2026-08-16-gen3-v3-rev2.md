...
- `diagnose_protocol_v2.py` is deliberately **out of scope**. Rev 2 calls for no
  diagnostic run; the file stays as the historical audit tool for v2.
...
Expected: `200 passed` (195 + 5). In particular the four rule-7 tests in
...
Run the scoped command. Expected: `203 passed` (200 + 3).
...
Run the scoped command. Expected: `212 passed` (203 + 9).
...
Run the scoped command. Expected: `216 passed` (212 + 4).
