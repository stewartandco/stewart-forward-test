...
| below_ma_downtrend_short | 0 | 400 | gauntlet 32 · graveyard 368 | exit/time_stop (400) |
...
| breakout_triple_barrier_geometry | 0 | 400 | gauntlet 305 · graveyard 95 | exit/time_stop (400) |
...
| downtrend_regime_short_ma_cross | 0 | 5 | gauntlet 1 · graveyard 4 | exit/time_stop (5), implicit ma_cross exit (5) |
...
| exit_geometry_mesh | 0 | 15 | gauntlet 15 | implicit ma_cross exit (15) |
...
| short_trend_speed_ladder | 0 | 5 | gauntlet 2 · graveyard 3 | exit/time_stop (5), implicit ma_cross exit (5) |
...
| slow_tstat_trend_long_regime_filtered | 0 | 240 | gauntlet 210 · graveyard 30 | exit/time_stop (240) |
| symmetric_breakout_fixedfraction | 0 | 2 | gauntlet 1 · graveyard 1 | exit/time_stop (2) |
| symmetric_breakout_voltarget_control | 0 | 5 | gauntlet 4 · graveyard 1 | exit/time_stop (5) |
...
| symmetric_donchian_horizon | 0 | 2 | gauntlet 2 | exit/time_stop (2) |
...
| trend_tvalue_stop_geometry | 0 | 5 | gauntlet 5 | exit/time_stop (5) |
| tstat_trend_both_asymmetric_payoff | 4 | 0 | — | — |
| tstat_trend_both_triple_barrier | 0 | 5 | gauntlet 5 | exit/time_stop (5) |
...
| uptrend_dip_reversion_extreme_tail | 0 | 400 | gauntlet 72 · graveyard 328 | stop/pct_stop (400), exit/time_stop (400) |
...
| vol_state_conditioned_breakout | 0 | 5 | gauntlet 5 | exit/time_stop (5) |
| vol_state_conditioned_symmetric_ma_cross | 0 | 15 | graveyard 15 | implicit ma_cross exit (15) |
| vol_state_filtered_breakout | 0 | 400 | gauntlet 325 · graveyard 75 | exit/time_stop (400) |
